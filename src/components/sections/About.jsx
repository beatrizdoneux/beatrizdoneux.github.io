    ...
    return (
        <Section id="about" title="About" aria-label="About me" >
            <div className="flex flex-col gap-4">
                <p className="">I'm a full stack developer focused on building clean, intuitive, and user-centered interfaces. I enjoy working at the intersection of design and development, creating responsive and accessible experiences with attention to detail and usability.</p>
