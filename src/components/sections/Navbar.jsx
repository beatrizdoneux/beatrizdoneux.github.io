            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-9 items-center justify-between">
                    <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        {/* Mobile menu button*/}
                        <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 hover:cursor-pointer">
                ...
                <div className="space-y-1 px-2 pt-2 pb-3">
                    {navigation.map((item) => (
                        <DisclosureButton
                            ...
                            className={classNames(
                                item.current ? '' : 'text-gray hover:text-blue dark:hover:text-white',
                                'block rounded-md px-3 py-2 hover:cursor-pointer',
                            )}
                        >
                            {item.name}
                        </DisclosureButton>
